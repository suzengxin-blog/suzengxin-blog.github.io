...
//首页按钮划过事件
$('.waifu-tool .fui-home').mouseenter(function (){
	showMessage('点击可以回到首页！', 1000, true);
})
//语言按钮点击事件
...
//语言按钮划过事件
$('.waifu-tool .fui-chat').mouseenter(function (){
	showMessage('你想听我说话吗？', 1000, true);
});
//换人按钮点击事件
...
//换人按钮划过事件
$('.waifu-tool .fui-eye').mouseenter(function (){
	showMessage('你不喜欢我了吗？', 1000, true);
});
//换装按钮点击事件
...
//换装按钮划过事件
$('.waifu-tool .fui-user').mouseenter(function (){
	showMessage('你是想给我换衣服吗？', 1000, true);
});
//拍照按钮点击事件
...
//拍照按钮划过事件
$('.waifu-tool .fui-photo').mouseenter(function (){
	showMessage('你是想给我拍照吗？', 1000, true);
});
//定制按钮点击事件
...
//定制按钮划过事件
$('.waifu-tool .fui-info-circle').mouseenter(function (){
	showMessage('你是想了解我吗？', 1000, true);
});
//关闭按钮点击事件
...
//关闭按钮划过事件
$('.waifu-tool .fui-cross').mouseenter(function (){
	showMessage('テ_デ下次再见吧~', 1000, true);
});
